...
return(
    <div className={`flex flex-col bg-white shadow-md m-4 mx-10 my-16 p-6 rounded  ${ featured && 'border-l-4 border-teal-500 border-solid lg:flex-row'}`}>
        <div>
        ...
        <div className='flex flex-col justify-between ml-4'>
            ...
            {isNew && <span className='text-teal-100 bg-teal-500 font-bold m-2 py-1 px-2 rounded-full uppercase text-sm'>New!</span>}
